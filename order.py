...
#         price += v
#         return price
#     print('Calculating bill subtotal...', price)


# print(calculate_subtotal(cake=2.79, sandwich=4.99))
# subtotal = calculate_subtotal(cake=2.79, sandwich=4.99)
...
#     """
#     print('Calculating tax from subtotal...',round((subtotal * .15), 2))
#     ### WRITE SOLUTION HERE
#     return(round((subtotal * .15), 2))
